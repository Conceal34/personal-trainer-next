...
import SiteHeader from "@/app/components/SiteHeader"; // Using alias for components
  ...
  return (
    <div className="bg-black text-white font-sans">
      ...
      <main className="isolate">
        ...
        <div className="relative">
          ...
          <div className="relative isolate py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
              <p className="text-lg font-semibold leading-8 text-amber-400">
                EXPERIENCE THE GREAT GYM OF KHARAR
              </p>
              <h1 className="mt-6 text-4xl font-bold tracking-tight sm:text-6xl">
                LIFT, <span className="text-amber-400">ASCEND</span>, DOMINATE
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Stop wishing, start doing. Your journey to greatness begins with
                a single step. Join us today.
              </p>
              <div className="mt-10">
        ...
        <section id="plans" className="w-full py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Take advantage of the early bird offer and save up to 10% on
                your subscription. Limited to the first 100 sign-ups only!
              </p>
            </div>
            <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
              {plans?.map((plan: Plan) => (
                <div
                  key={plan.id}
                  className="flex flex-col p-8 bg-gray-900/50 rounded-2xl border-2 border-gray-700 hover:border-amber-400 transition-all"
                >
                  <p className="mb-6 text-center text-xs font-medium bg-amber-50 text-black p-2 rounded-full w-fit mx-auto px-4">
                    VALID FOR FIRST 100 SIGNUPS
                  </p>
        ...
        <section
          id="about"
          className="flex flex-col lg:flex-row w-full items-center gap-12 px-6 lg:px-8 py-24 sm:py-32"
        >
          <div className="w-full lg:w-1/2">
            <p className="text-lg font-semibold leading-8 text-amber-400 mb-2">
              ABOUT US
            </p>
            ...
            <p className="text-lg text-gray-300 leading-8">
              At Ascend Fitness, every workout is a masterclass in performance.
              Whether you are sculpting a chiseled physique, amplifying your
              strength, or boosting your endurance, our pro-trainers will help
              you at every corner.
            </p>
      ...
      <footer className="mx-auto max-w-7xl px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 border-t border-gray-700 pt-8">
          ...
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Ascend Fitness. All rights
            reserved.
          </p>
        </div>
      </footer>

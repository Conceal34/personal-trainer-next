...
import { sendMessage } from "@/app/dashboard/client/actions"; // Import the Server Action
    ...
    <div className="bg-gray-900/50 p-6 rounded-2xl border border-gray-700 flex flex-col h-[60vh]">
      ...
      <div className="flex-grow overflow-y-auto pr-4 space-y-4">
        {messages.map((msg) => (
          ...
          >
            <div
              className={`max-w-xs lg:max-w-md p-3 rounded-lg ${msg.sender_id === userId ? "bg-amber-500 text-black" : "bg-gray-700 text-white"}`}
            >
      ...
      <form
        ...
        className="mt-4 pt-4 border-t border-gray-700 flex items-center gap-2"
      >
        <input
          type="text"
          value={newMessage}

...
import { getChartDataForClient } from "@/app/admin/actions";
...
export function ProgressChart({
    ...
    return (
      <div>
        ...
        <div className="bg-gray-900/50 p-6 rounded-2xl border border-gray-700 text-center text-gray-400">
          Select an exercise from the log history filters to view its progress
          chart.
        </div>
      </div>
    );
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-white mb-4">
        Performance Tracker: {selectedExercise}
      </h2>
      <div className="bg-gray-900/50 p-6 rounded-2xl border border-gray-700">
        <div className="mb-4">
          ...
          <select
            ...
            className="mt-1 block w-full max-w-xs rounded-md bg-white/5 py-2 pl-3 text-white ring-1 ring-white/10"
          >
            <option value="totalVolume" className="text-black">
              Total Volume
            </option>
            <option value="maxWeight" className="text-black">
              Max Weight
            </option>
            <option value="singleSetVolume" className="text-black">
              Best Set Volume
            </option>
            <option value="e1rm" className="text-black">
              Est. 1-Rep Max
            </option>
          </select>
        </div>

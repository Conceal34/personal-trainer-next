...
export default function AuthPage() {
  ...
  // const handleAuthError = (error): void => {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-black p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link
            href="/"
            className="text-3xl font-bold tracking-wider text-white hover:text-amber-200 transition-colors"
        ...
        <div className="bg-gray-900/50 p-8 rounded-2xl border border-gray-700 space-y-6 backdrop-blur-sm">
          ...
          {message && (
            <div
              className={`text-sm text-center p-3 rounded-lg ${getMessageStyle(message.type)}`}
            >
              {message.text}
            </div>
          )}
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          <Link
            href="/"
            className="font-semibold leading-6 text-amber-400 hover:text-amber-300 transition-colors"
          >
            &larr; Back to Home
          </Link>
        </p>
